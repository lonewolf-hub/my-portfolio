...
import { AiFillGithub, AiOutlineTwitter, AiOutlineMail, AiOutlineDownload } from 'react-icons/ai'
...
<Position>
          ...
          <div className='my-4 flex items-center justify-center'>
            <a href='/assets/resume/jairesume.pdf' download='Jai_Shukla_Resume.pdf'>
              <button className='flex  bg-[#5651e5] text-white py-2 px-6 rounded-full hover:bg-[#463eca] transition duration-300'>
                Download Resume
