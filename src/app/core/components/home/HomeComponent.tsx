    ...
    <div id='home' className=' w-full h-screen text-center bg-bodyBackground'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          ...
          <div className='my-4'>
            <a href='/path/to/your/resume.pdf' download='Jai_Shukla_Resume.pdf'>
              <button className='bg-[#5651e5] text-white py-2 px-6 rounded-full hover:bg-[#463eca] transition duration-300'>
                Download Resume
              </button>
            </a>
          </div>
